...
Original file is located at
    https://colab.research.google.com/drive/1opyRxsLsn5enFnf2ajrdDBBiPQVgsqY1
"""
...
img = mpimg.imread('/content/data/without_mask/without_mask_2995.jpg')
imgplot = plt.imshow(img)
plt.show()
